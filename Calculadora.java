...
public class Calculadora {
	...
	public static void calc() {
		...
		try {
			...
			do {
				System.out.println(
						"Digite 1 para somar, 2 para subtrair, 3 para multiplicar, 4 para dividir, 5 para fazer uma raiz quadrada ou 6 para uma potenciação: ");
				int opcao = sc.nextInt();
				while (opcao > 6 || opcao < 1) {
					System.out.println("Opção inválida, tente novamente!");
					System.out
							.println("Digite 1 para adição, 2 para subtração, 3 para multiplicação ou 4 para divisão: ");
					opcao = sc.nextInt();
				}
				if (opcao == 1) {
					...
					System.out.println(
							"Digite 0 para encerrar o programa ou qualquer outro número para fazer outra conta: ");
